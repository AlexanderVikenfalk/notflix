                ...
                <div className="border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div className="p-4 border-b border-gray-100 dark:border-gray-700">
                        ...
                        >
                            ...
                            {GENRES.filter((genre) => !filters.genre.includes(genre)).map((genre) => (
                        ...
                        <div className="flex items-center gap-3 max-w-md">
                            <div className="flex-1">
                                <input
                                    ...
                                    onChange={(e) =>
                                        handleReleaseDateChange('from', e.target.value)
                                    }
                            ...
                            <div className="flex-1">
                                <input
                                    ...
                                    onChange={(e) =>
                                        handleReleaseDateChange('to', e.target.value)
                                    }
                                    className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                            </div>
                        ...
                        <div className="flex items-center gap-3 max-w-md">
                            <div className="flex-1">
                                <input
                                    ...
                                    onChange={(e) =>
                                        handleRatingChange('from', e.target.value)
                                    }
                                    className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                            </div>
